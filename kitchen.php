                    ...
                    <div class="col-3 mb-3">
                        <div class="card deviceInRoomCard">
                            <div class="card-body">
                                <h4>Oven</h4>
                                <p class="text-center">
                                    <i id="ac" class="text-danger fa-solid fa-fire" style="font-size:7rem;"></i>
                                </p>
                                <p class="text-center">
                    ...
                    <div class="col-3 mb-3">
                        <div class="card deviceInRoomCard">
                            <div class="card-body">
                                <h4>Windows</h4>
                                <p class="text-center">
                                    <i id="windows" class="text-secondary fa-solid fa-table-cells-large"
                                        style="font-size:7rem;"></i>
                                </p>
                                <p class="text-center">
                                    <span id="windowsStatus" class="fs-5">Off</span>
                                </p>
                            </div>
                        </div>
                    </div>
